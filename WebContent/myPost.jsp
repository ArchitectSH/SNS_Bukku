...
<html>
	<head>
		<meta charset="utf-8">
		<title>Bukku</title>
		<link href="css/mypost.css" rel="stylesheet" type="text/css"></link>
		<script src = "javascript/mypost.js" type="text/javascript" charset="UTF-8"></script>
...
//					$postNo = $(this).parents('.postDiv').find('input.recommendHidden').val();
			...
			<div id="allDiv">
				...
				<table id="tb">
					<tr>
						<td id="profileImage"><a href=""><img src="${userBean.profileImg}"/></a></td>
					</tr>
			...
			<br/>
				...
				<c:if test="${postAllInfoBean.postingViewBean.mypageTitle==null}">
									...
									<textarea class="modifyText" name="contents"></textarea><br />
										<table id="modifyTable" >
											...
											<tr>
												<td rowspan="2"><input type="file" name="f1" id="f1"/><img src="image/photo.jpg" id="imageBtn"></td>
												<td rowspan="2"><input type="file" name="f2" id="f2"/><img src="image/video.jpg" id="videoBtn"></td>
												<td><a href="#"><img src="image/all.btn" class="allBtn" /></a></td>
												<td><a href="#"><img src="image/friend.btn" class="friendBtn" /></a></td>
												<td><a href="#"><img src="image/secret.btn" class="secretBtn" /></a></td>

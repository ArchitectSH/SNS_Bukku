...
<body>
	...
	<div id="all_popup2" style="display: none;">
		...
		<div class="popup_box" style="width: 350px; height: 160px; margin-top: -80px;">
			...
			<div class="popup_contents">
				<!-- popup_contents 안에서 자유 디자인 -->
				<div id="findResult">아이디를 찾았습니다!</div><br />
				회원님의 아이디 : wltmdgk123<br />	<br />
				<form method="" action="" id="loginFrm">
					<input type="button" id="loginBtn"  class="btn btn-info" value="로그인">
				</form>
				<form method="" action="" id="pwdFrm">
					<input type="button" id="pwdBtn"  class="btn btn-info" value="비밀번호 찾기">
				</form>
							...
							<table id="findTable">
								<tr>
									<td colspan="2" class="kindTd">
										<input type="radio" name="choice" id="choice" value="nameEmail" />&nbsp;이름과 이메일로 찾기
									</td>
								</tr>
								<tr>
									<td>이름</td>
								...
								<tr>
									<td colspan="2" class="kindTd">
										<input type="radio" name="choice" id="choice" value="nameCellPhone" />&nbsp;이름과 핸드폰번호로 찾기
									</td>
								</tr>
								<tr>
									<td>이름</td>
